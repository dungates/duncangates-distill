...
icon_link("github", "source", "https://github.com/dungates/distilltools")
```
...
Expect to hear much more from me, both on this blog and [twitter](https://twitter.com/gates_duncan), about {distilltools} in the near future.
