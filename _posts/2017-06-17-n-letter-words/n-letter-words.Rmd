...
So, [here](https://github.com/dungates/EMK) is my personal package, `EMK`. If you think that `n_letter_words` might be of use to you, then feel free to install!

```{r message=FALSE, eval = FALSE}
devtools::install_github("dungates/EMK")
```
