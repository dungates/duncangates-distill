...
icon_link(
  icon = "github",
  text = "materials",
  url = "https://github.com/dungates/useR-2017-talk"
)
...
I am very excited to be introducing the package `BradleyTerryScalable` at useR!2017. The package is available on [GitHub](https://github.com/dungates/BradleyTerryScalable).
